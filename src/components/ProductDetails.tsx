            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mb-4">
                <span className="flex items-center">
                  <svg
                    ...
                    strokeWidth="2"
                    className="w-4 h-4 text-primaryy-500"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                <div className="flex">
                  ...
                  <button className="border-2 border-gray-300 ml-1 bg-primaryy-500 rounded-full w-6 h-6 focus:outline-none"></button>
                </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center">
                  <button
                    ...
                    className="flex ml-auto mr-2 text-white bg-primaryy-500 border-0 py-2 px-6 focus:outline-none hover:bg-primaryy-700 rounded"
                  >
                    Buy it now
                  </button>
                  <button
                    onClick={() => addToCart(product, false)}
                    className="flex ml-auto text-white bg-primaryy-500 border-0 py-2 px-6 focus:outline-none hover:bg-primaryy-700 rounded"
                  >
                    Add to cart
                  </button>
                </div>
